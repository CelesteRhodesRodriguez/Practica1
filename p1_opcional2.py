"""
Práctica 1: Programación concurrente (parte opcional). De: Celeste Rhodes Rodríedguez.
"""
...
def main():
    ...
    empty = [BoundedSemaphore(K) for i in range(NPROD)] #representa el numero de huecos en el buffer. -1 cuando aes(wait), +1 cuando quitas(signal), 0 completo(no te dejo pasar)
